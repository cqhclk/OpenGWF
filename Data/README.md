...
| **WeatherBench 2** | An updated version with improved metrics and additional variables. || [WeatherBench 2](https://weatherbench2.readthedocs.io/en/latest/data-guide.html) |
